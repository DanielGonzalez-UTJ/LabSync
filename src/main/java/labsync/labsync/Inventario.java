...
public class Inventario extends javax.swing.JFrame {
    ...
    private void limpiarCamposEquipo() {
        ...
        cmbEstadoModal.setSelectedIndex(0);
    }
    ...
    private boolean validarCamposEquipo() {
        ...
        if (cmbEstadoModal.getSelectedIndex() == 0) {
            mostrarErrorValidacion("Selecciona el estado del equipo.", cmbEstadoModal);
            return false;
        }
    ...
    private boolean guardarEquipoBD() {
        ...
        String estadoEquipo = cmbEstadoModal.getSelectedItem().toString();
    ...
    private boolean actualizarEquipoBD() {
        ...
        try {
            ...
            ps.setString(8, estadoEquipo);
            ps.setString(9, observaciones);
            ps.setString(10, codigoOriginal);
    ...
    private void cargarTablaInventarioFiltrada() {
        ...
        if (!textoBusqueda.isEmpty()) {
            sql += "AND (codigo LIKE ? OR nombre_equipo LIKE ? OR marca LIKE ? OR modelo LIKE ? OR no_serie LIKE ?) ";
    ...
    private void initComponents() {
        ...
        cmbEstadoModal = new javax.swing.JComboBox<>();
        ...
        lbTituloModal.setPreferredSize(new java.awt.Dimension(250, 30));
        bodyModal.add(lbTituloModal, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 25, 200, -1));
        ...
        bodyModal.add(lbEstadoModal, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 310, -1, -1));

        cmbEstadoModal.setBackground(new java.awt.Color(255, 255, 255));
        cmbEstadoModal.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        cmbEstadoModal.setForeground(new java.awt.Color(102, 102, 102));
        cmbEstadoModal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona", "Disponible", "En uso", "Con falla", "Dado de baja" }));
        cmbEstadoModal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        bodyModal.add(cmbEstadoModal, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 220, -1));
        ...
        bodyModal.add(lbOberservaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, -1, -1));
        ...
        bodyModal.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 500, 65));
        ...
        bodyModal.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 490, 160, 40));
        ...
        bodyModal.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 490, 160, 40));
        ...
        sidebar.add(btnMant, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, -1, -1));
        ...
        sidebar.add(btnReservas, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, -1, -1));
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        cmbEstadoModal.setSelectedItem(tablaInventario.getValueAt(filaSeleccionada, 7).toString());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        lbTituloModal.setText("Regisrar Equipo");
        btnGuardar.setText("Guardar");
    ...
    private javax.swing.JComboBox<String> cmbEstadoModal;
