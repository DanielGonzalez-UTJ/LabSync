...
public class Mantenimiento extends javax.swing.JFrame {
    ...
    private boolean validarCamposMantenimiento() {
        ...
        if (txtFechaProgramada.getText().trim().isEmpty()) {
            mostrarErrorValidacion("Ingrese la fecha programada.", txtFechaProgramada);
            return false;
        }
        
        if (!validarFormatoFecha(txtFechaProgramada.getText().trim())) {
            mostrarErrorValidacion("La fecha debe tener el formato: AAAA-MM-DD.", txtFechaProgramada);
            return false;
        }
    ...
    private boolean guardarMantenimientoBD() {
        ...
        String fechaProgramada = txtFechaProgramada.getText().trim();
    ...
    private void initComponents() {
        ...
        addMantenimiento.setPreferredSize(new java.awt.Dimension(560, 560));
        ...
        txtFechaProgramada.setBackground(new java.awt.Color(255, 255, 255));
        txtFechaProgramada.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        txtFechaProgramada.setForeground(new java.awt.Color(51, 51, 51));
        txtFechaProgramada.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        txtFechaProgramada.setFocusAccelerator('D');
        bodyModal.add(txtFechaProgramada, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 220, 24));
        ...
        cmbEstadoMantModal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona", "Pendiente", "En proceso", "Realizado", "Cancelado" }));
        cmbEstadoMantModal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        bodyModal.add(cmbEstadoMantModal, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 220, -1));
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        txtFechaProgramada.setText(tablaMantenimiento.getValueAt(filaSeleccionada, 5).toString());
